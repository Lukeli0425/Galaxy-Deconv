...
**An illustration of performance at multiple SNR levels.** This figure is created with ['grid_plot.ipynb'](grid_plot.ipynb).

### Figure 3: ([`err_snr.jpg`](err_snr.jpg))

**Average ellipticity errors at multiple SNR levels.** 
